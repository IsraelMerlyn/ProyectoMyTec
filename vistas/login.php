...
<link rel="stylesheet" type="text/css" href="../public/css/compiled/estilo.css"/>
...
<span class="input-group-addon"><i class="fa fa-user"></i></span>
 <input class="form-control" type="text" id="logina" name="logina" placeholder="Nombre de Usuario">
</div>
<p><label for="usuarioingreso">Usuario</label></p>
<div class="input-group">

<span class="input-group-addon"><i class="fa fa-key"></i></span>
<input type="password" class="form-control" id="clavea" name="clavea" placeholder="Contraseña">
</div>
<div class="row">
    <div class="col-xs-12">
    <button type="submit" class="btn btn-success col-xs-12">Iniciar Sesíon</button>
    </div>
</div>
</form>
</div>
